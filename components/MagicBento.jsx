...
import '@/app/styles/magic-bento.css';

const DEFAULT_PARTICLE_COUNT = 12;
const DEFAULT_SPOTLIGHT_RADIUS = 300;
const DEFAULT_GLOW_COLOR = '132, 0, 255'; // Vibrant Purple / Neon RGB
...
export const MagicBentoCard = ({
    ...
    }, [animateParticles, clearAllParticles, disableAnimations, enableTilt, enableMagnetism, clickEffect, glowColor, enableStars, externalMouseMove, externalMouseLeave]);
    ...
    return (
        <div
            ref={cardRef}
            className={`magic-bento-card magic-particle-container ${borderGlowClass} ${className}`}
            style={{
