        ...
        <section className="showreel-section" id="showreel-section" ref={sectionRef}>
            ...
            <div className="showreel__container">
                ...
                >
                    ...
                    {/* Flagship Commercial Client SaaS: Premium Mess */}
                    <MagicBentoCard
                        className="showreel__spotlight-card"
                        glowColor="255, 140, 66"
                        particleCount={20}
                        enableTilt={true}
                        enableMagnetism={true}
                    ...
                    >
                        ...
                        <div className="showreel__spotlight-layout">
                            <div className="showreel__spotlight-media">
                                <div className="showreel__spotlight-img-wrap">
                                    <img
                                        src="/assets/projects/premium-mess.png"
                                        alt="Premium Mess - Dubai Client SaaS"
                                        className="showreel__spotlight-img"
                                    />
                                    <div className="showreel__spotlight-live-pill">
                                        <span className="showreel__badge-dot" />
                                        LIVE PRODUCTION • DUBAI, UAE
                                    </div>
                                </div>
                            </div>

                            <div className="showreel__spotlight-info">
                                <div>
                                    <div className="showreel__project-top">
                                        <span className="showreel__project-tag showreel__project-tag--orange">
                                            ...
                                            Commercial Client SaaS • Enterprise ERP
                                        </span>
                                        <span className="showreel__spotlight-role">Freelance Full-Stack SaaS Architect</span>
                                    </div>

                                    <h3 className="showreel__spotlight-title">
                                        Premium Mess — Meal Prep Subscription &amp; Kitchen ERP Platform
                                    </h3>

                                    <p className="showreel__spotlight-desc">
                                        High-performance subscription SaaS engineered for meal prep catering in Dubai. Automates 30-day dynamic dish scheduling, split dual-location delivery routing (lunch at office, dinner at apartment), and headless Chromium PDF tax invoicing.
                                    </p>

                                    <div className="showreel__spotlight-metrics-row">
                                        <div className="showreel__spotlight-metric">
                                            <span className="showreel__spotlight-mval">4 hrs/day</span>
                                            <span className="showreel__spotlight-mlbl">Kitchen coordination saved</span>
                                        </div>
                                        <div className="showreel__spotlight-metric">
                                            <span className="showreel__spotlight-mval">100%</span>
                                            <span className="showreel__spotlight-mlbl">Automated delivery manifests</span>
                                        </div>
                                        <div className="showreel__spotlight-metric">
                                            <span className="showreel__spotlight-mval">0%</span>
                                            <span className="showreel__spotlight-mlbl">Sunday feast billing leakage</span>
                                        </div>
                                    </div>
                                </div>

                                <div className="showreel__spotlight-footer">
                                    <div className="showreel__tech-chips">
                                        <span className="showreel__tech-chip">Next.js 16</span>
                                        <span className="showreel__tech-chip">TypeScript</span>
                                        <span className="showreel__tech-chip">PostgreSQL</span>
                                        <span className="showreel__tech-chip">Prisma</span>
                                        <span className="showreel__tech-chip">Puppeteer</span>
                                        <span className="showreel__tech-chip">Docker</span>
                                    </div>

                                    <div className="showreel__spotlight-actions">
                                        <button
                                            type="button"
                                            onClick={() => setIsModalOpen(true)}
                                            className="showreel__spotlight-btn showreel__spotlight-btn--case"
                                        >
                                            Deep-Dive Case Study 🍱
                                        </button>
                                        <a
                                            href="https://premiummess.com/"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="showreel__spotlight-btn showreel__spotlight-btn--live"
                                        >
                                            Visit Live Site ↗
                                        </a>
                                    </div>
