                            ...
                            <div className="nav-popout-inner">
                                <div className="nav-work-item">
                                    ...
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-maroon">marksorting</span>
                                        <h4 className="nav-work-title">machinery lifecycle & field service</h4>
                                    </div>
                                </div>
                                <div className="nav-work-item">
                                    <div className="nav-work-item__img-wrap">
                                        <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=600&q=80" loading="eager" alt="Onetouch ERP" className="nav-work-item__img" />
                                    </div>
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-pink">onetouch erp</span>
                                        <h4 className="nav-work-title">enterprise order workflows</h4>
                                    </div>
                                </div>
                                <div className="nav-work-item">
                                    <div className="nav-work-item__img-wrap">
                                        <img src="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=600&q=80" loading="eager" alt="SkyNet Plugin" className="nav-work-item__img" />
                                    </div>
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-darkblue">skynet plugin</span>
                                        <h4 className="nav-work-title">shopify & woo shipping engine</h4>
                                    </div>
                                </div>
                                <a href="#projects" className="nav-work-btn"><span className="nav-work-btn__text">all projects & code</span></a>
                            </div>
                        </div>
                    </div>
                </div>
