...
const STAGGERED_MENU_ITEMS = [
    ...
    { label: 'WORKS', ariaLabel: 'View featured works and projects', link: '#projects' },
    { label: 'SHOWREEL', ariaLabel: 'Watch showreel and metrics', link: '#showreel-section' },
    { label: 'SERVICES', ariaLabel: 'Explore services and tech stack', link: '#services' },
    { label: 'CONTACT', ariaLabel: 'Get in touch with Suresh', link: '#contact' },
];
...
export default function Navbar() {
    useEffect(() => {
        ...
        // ─── Navbar Left (Work Blob) Subtle Spin on Hover ───
        const logoWorkContainer = document.querySelector('.logo-work-container');
        const workBlob = document.querySelector('.nav-bar__work-blob-svg');

        if (logoWorkContainer && workBlob) {
            gsap.set(workBlob, { transformOrigin: 'center center' });
            const onBlobEnter = () => {
                gsap.to(workBlob, { rotation: '+=180', duration: 0.6, ease: 'power2.out' });
            };
            logoWorkContainer.addEventListener('mouseenter', onBlobEnter);
            cleanups.push(() => {
                logoWorkContainer.removeEventListener('mouseenter', onBlobEnter);
            });
        }
            ...
            <nav className="navbar">
                <div className="nav-left">
                    <a
                        ...
                        style={{ cursor: "url('/assets/Cursor SVG/cursor-pointer.svg') 12 12, pointer", textDecoration: 'none', color: 'inherit' }}
                        onClick={(e) => {
                            e.preventDefault();
                    ...
                    >
                        ...
                        <span className="logo-work-text">suresh</span>
                    </a>
                </div>
                ...
                <div className="nav-right">
                    {/* StaggeredMenu circular button & drawer navigation */}
                    <StaggeredMenu
                        position="right"
                    ...
                    <div className="nav-hover-trigger" style={{ cursor: "url('/assets/Cursor SVG/cursor-pointer.svg') 12 12, pointer" }}>
                        ...
                        <div className="nav-popout nav-wa-box">
                            <div className="nav-popout-inner">
                                ...
                                <h4 className="nav-wa-title">whatsapp suresh</h4>
                                <p className="nav-wa-desc">Connect directly on WhatsApp (+91 9361880749) for freelance projects, contract engineering & full-time roles.</p>
                                <a href="https://wa.me/919361880749" target="_blank" rel="noopener noreferrer" className="nav-wa-link">
                                    <span className="nav-wa-link-text">Chat on WhatsApp</span>
