...
export default function ServiceCards() {
    ...
    return (
        <>
            {/* ─── "Hire me if you need:" Heading ─── */}
            <div className="title-container">
                <h2 className="main-title">hire me if you <span className="italic-text">need:</span></h2>
                ...
                <div className="service-freelance-wrap">
                    <span className="service-freelance-badge">
                        <span className="service-freelance-dot" />
                        available for freelance contracts • full-stack mvps • backend consulting
                    </span>
                </div>
            </div>
