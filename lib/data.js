// ─── lib/data.js — All static data for Suresh Shanmugasundaram's portfolio ───
// ES Module exports — imported by React components

// Marquee brand logos (Suresh's Core Technology Ecosystem)
export const brands = [
    { name: "TypeScript", src: "/assets/Tech Logos/typescript.svg" },
    { name: "NestJS", src: "/assets/Tech Logos/nestjs.svg" },
    { name: "Node.js", src: "/assets/Tech Logos/nodejs.svg" },
    { name: "React", src: "/assets/Tech Logos/react.svg" },
    { name: "Next.js", src: "/assets/Tech Logos/nextjs.svg" },
    { name: "Python", src: "/assets/Tech Logos/python.svg" },
    { name: "PostgreSQL", src: "/assets/Tech Logos/postgresql.svg" },
    { name: "Redis", src: "/assets/Tech Logos/redis.svg" },
    { name: "Docker", src: "/assets/Tech Logos/docker.svg" },
    { name: "AWS", src: "/assets/Tech Logos/aws.svg" }
];
...
export const SOCIAL_ICONS = [
    {
        href: 'https://linkedin.com/in/suresh-shanmugasundaram-7590ab279',
        label: 'LinkedIn',
    ...
    {
        href: 'https://github.com/sureshdeveloperofficial',
        label: 'GitHub',
        svg: '<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-wiggle-target="" aria-hidden="true"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>'
    },
    {
        href: 'https://suresh-shanmugasundaram-portfolio.vercel.app',
        label: 'Portfolio',
        svg: '<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-wiggle-target="" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>'
    }
];

// Service cards data (Suresh's Core Engineering Domains)
export const CARDS_DATA = [
    ...
    },
    {
        ...
        services: [
            ...
            'N+1 Query Elimination (75% faster)',
            'ACID Knex Transactions',
    ...
    },
    {
        ...
        services: [
            ...
            'SSRF Mitigation & Content Checks',
    ...
    },
    {
        ...
        services: [
            ...
            'FastAPI AI Model Services',
            'Jest & Automated API Testing'
        ]
    }
];
...
// ─── Featured Client Project: Premium Mess (Dubai, UAE) ──────────────────────
export const PREMIUM_MESS_DATA = {
    title: "Premium Mess — Enterprise Meal Subscription & Kitchen ERP Platform",
    shortTitle: "Premium Mess",
    ...
    client: "Commercial Dubai Client (UAE)",
    liveUrl: "https://premiummess.com/",
    phone: "+971 50 123 4567",
    heroImage: "/assets/projects/premium-mess.png",
    role: "Full-Stack SaaS Architect & Lead Engineer (Freelance)",
    stack: [
    ...
    metrics: [
        { value: "4 hrs/day", label: "Saved in daily manual coordination" },
        { value: "100%", label: "Automated daily manifests & dispatch routing" },
        { value: "0%", label: "Billing leakage on Sunday feast add-ons" },
        { value: "<100ms", label: "Catalog & scheduling response time" }
    ],
    features: [
        {
            title: "Dynamic 30-Day Scheduling Engine",
            desc: "Calculates rolling 30-day subscriptions, isolates workdays from Sunday feast specials, and recalculates pricing dynamically in real time."
        },
        {
            title: "Dual-Location Delivery Routing",
            desc: "Allows subscribers to route daytime meals (brunch/lunch) to office desks and evening dinners to their residential apartments."
        },
        {
            title: "Headless Chromium PDF Invoicing",
            desc: "Generates vectorized, pixel-perfect A4 tax invoices with QR verification server-side using puppeteer-core & sparticuz/chromium, with automatic SMTP email dispatch."
        },
        {
            title: "Kitchen ERP & Manifest Dashboard",
            desc: "Provides real-time production counts by meal slot and category, dynamic menu configuration, and zero-downtime database-driven system settings."
        }
    ]
};
